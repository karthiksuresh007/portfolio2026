  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-4 sm:px-6">
      <div className="mx-auto max-w-5xl">
        <div className="relative rounded-[1.8rem] border border-white/70 bg-white/68 px-3 py-3 shadow-[0_22px_60px_rgba(20,19,18,0.08)] backdrop-blur-2xl supports-[backdrop-filter]:bg-white/60">
