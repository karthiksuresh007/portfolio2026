...
function GalleryScene({
  ...
  useEffect(() => {
    wheelHostRef.current = document.querySelector("[data-explore-hero-gallery]");
  }, []);
  ...
  useEffect(() => {
    ...
    wheelHost.addEventListener("wheel", handleWheel, { passive: false });
...
function FallbackGallery({ images }: { images: ImageItem[] }) {
  ...
  return (
    <div className="flex h-full items-center justify-center bg-[#0f0d0c] p-4">
      <div className="grid max-h-full grid-cols-2 gap-3 overflow-y-auto md:grid-cols-4">
